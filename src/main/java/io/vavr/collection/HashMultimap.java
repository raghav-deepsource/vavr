...
public final class HashMultimap<K, V> extends AbstractMultimap<K, V, HashMultimap<K, V>> implements Serializable {
    ...
    public static class Builder<V> {
        ...
        /**
         * Returns a HashMultimap containing {@code n} values of a given Function {@code f}
         ...
         * @return A HashMultimap of size {@code n}, where each element contains the result supplied by {@code s}.
        ...
        /**
         * Creates a HashMultimap of the given key-value pair.
         * Returns a singleton {@code HashMultimap}, i.e. a {@code HashMultimap} of one entry.
         *
         * @param <K>   The key type
         * @param <V2>   The value type
